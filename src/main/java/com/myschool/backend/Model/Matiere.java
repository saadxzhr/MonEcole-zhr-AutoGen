...
public class Matiere {
        ...
        // @Id
        // @Column(name = "code_matiere", unique = true, nullable = false) // Ensure 'cin' is unique and not nullable
        ...
        @ManyToOne
        @JoinColumn(name = "code_filiere", referencedColumnName = "code_filiere", insertable = false, updatable = false)
