...
//                 auth.requestMatchers("/login", "/css/**", "/js/**", "/v3/api-docs/**",
// "/swagger-ui/**", "/swagger-ui.html").permitAll();
//                 auth.requestMatchers("/direction/**").hasRole("Direction");
//                 auth.requestMatchers("/secretariat/**").hasRole("Secretariat");
//                 auth.requestMatchers("/generate-recurring/**").hasAnyRole("Direction",
// "Secretariat");
//                 auth.requestMatchers("/formateur/**").hasAnyAuthority("ROLE_Formateur_Vacataire",
// "ROLE_Formateur_Permanent");
