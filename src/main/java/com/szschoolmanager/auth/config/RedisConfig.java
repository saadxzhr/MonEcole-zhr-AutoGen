...
public class RedisConfig {
  ...
  /**
   * Atomic rate limit script using Lua. Guarantees INCR + EXPIRE happen atomically (no race
   * condition).
   *
   * <p>Returns current count after increment.
   */
  @Bean
  ...
  /**
   * Alternative: Sliding window script for more accurate rate limiting. Uses sorted sets to track
   * individual requests.
   */
  @Bean
