...
import com.szschoolmanager.auth.model.*;
...
public class UtilisateurService {
  ...
  public ResponseEntity<ResponseDTO<Page<UtilisateurResponseDTO>>> list(
    ...
    if (roleFilter != null && !roleFilter.isBlank()) {
      ...
      Role rEnum = null;
      try {
        rEnum = Role.valueOf(roleFilter.toUpperCase());
  ...
  // Change password (user action) - if forceChangePassword true, oldPassword may be optional if
  // admin reset
