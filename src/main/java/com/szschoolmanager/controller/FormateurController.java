...
public class FormateurController {
  ...
  //     String cin = principal.getName();
  //     List<EtatDavancement> enAttente = etatDavancementService.getByCinAndStatut(cin, "En
  // attente");
  //     List<EtatDavancement> toupdate = etatDavancementService.getByCinAndStatut(cin, "A
  // modifier");
  ...
  //     //charger historique (charge que les enregistrement avant 'today' grace a
  // getByCinAndDateBeforeToday dans repository)
  ...
  //     public String updateEtat(@PathVariable Long id, @ModelAttribute EtatDavancement
  // updatedEtat) {
